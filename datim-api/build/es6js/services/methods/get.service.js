...
export function getJson(endpointUrl, options) {
    return __awaiter(this, void 0, void 0, function () {
        var response;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, getData(endpointUrl, mergeOptions(options, ContentType.json)).then(function (r) { return r.json(); })["catch"](function (error) {
...
export function getText(endpointUrl, options) {
    return getData(endpointUrl, mergeOptions(options, ContentType.text)).then(function (r) { return r.text(); });
}
...
function getData(endpointUrl, options) {
    ...
    return fetch(getFullUrl(endpointUrl), __assign({ credentials: 'include' }, options));
}
