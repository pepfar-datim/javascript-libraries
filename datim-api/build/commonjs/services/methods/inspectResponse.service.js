...
function getErrorMessage(errorType, apiResponse) {
    switch (errorType) {
        ...
        case http_types_1.ErrorType.httpError:
...
function inspectResponse(rawResponse) {
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    ...
                    if (!rawResponse.ok)
                        return [2 /*return*/, failService.fail(http_types_1.ErrorType.httpError)];
                    if (rawResponse.redirected && rawResponse.url.includes('login'))
                        return [2 /*return*/, failService.fail(http_types_1.ErrorType.silentRedirect)];
                    ...
                    if (responseBody.status === 'ERROR')
                        try {
                            if (responseBody.typeReports[0].objectReports[0].errorReports[0].message.includes('matching'))
                                return [2 /*return*/, failService.fail(http_types_1.ErrorType.alreadyExists)];
                            else
                                return [2 /*return*/, failService.fail(http_types_1.ErrorType.dhis2ErrorSpecified)];
                        }
                        catch (e) {
                            return [2 /*return*/, failService.fail(http_types_1.ErrorType.dhis2ErrorUnspecified)];
                        }
                    return [3 /*break*/, 4];
                case 3:
                    e_1 = _c.sent();
                    return [2 /*return*/, failService.fail(http_types_1.ErrorType.cannotParse)];
