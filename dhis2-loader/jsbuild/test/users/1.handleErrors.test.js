...
var testCases = [{
        ...
        response: {
            ok: true,
            redirected: false,
            text: function () { return Promise.resolve("{\"status\":\"ERROR\"}"); }
        },
        expectError: true
    }];
testCases.forEach(function (_a) {
    var response = _a.response, name = _a.name, expectError = _a.expectError;
    test("1 > Users > Handle Errors > ".concat(name), function () { return __awaiter(void 0, void 0, void 0, function () {
        var apiResponse;
...
//# sourceMappingURL=1.handleErrors.test.js.map